export CFLAGS="-UHAVE_UTIME_H -DHAVE_SOCKETPAIR=0 -DDISABLE_UTMP -DDISABLE_UTMPX -DDISABLE_WTMP -DDISABLE_WTMPX -DNO_UTC_OFFSET -I$(pwd)/dependence/aarch64-libcrypt-install/include -g -O0"
export CC=aarch64-linux-musl-gcc
export AR=aarch64-linux-musl-ar
export RANLIB=aarch64-linux-musl-ranlib
export LDFLAGS="-static -L$(pwd)/dependence/aarch64-libcrypt-install/lib -lcrypt"
